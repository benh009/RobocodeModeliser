	...
	public SCXMLEditorMenuBar(final SCXMLGraphEditor ed)
	{
		...
		item.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) {
                ...
                JMenuItem itemHelpRocode = menu.add(new JMenuItem(mxResources.get("AboutRoboCodeModiliser")));
		itemHelpRocode.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) {
				Window parent;
				String svn="";
				String info="Ce programme est un outils permettant de créer des modèles "
                                        + "permantant de définir la stratégie d'un tank dans le jeu robotCode ";
				try {
